  ...
  return (
    <div ref={ref} className={`scroll-zoom ${isVisible ? 'visible' : ''}`} style={{ transitionDelay: `${index * 0.1}s` }}>
      <Card className="glass-premium overflow-hidden transition-all duration-300 hover:scale-105 card-glow group">
        <div className="relative aspect-video overflow-hidden bg-card/60">
          {isPlaying ? (
            <iframe
            ...
            <div className="relative w-full h-full cursor-pointer" onClick={() => setIsPlaying(true)}>
              ...
              <div className="absolute inset-0 bg-background/30 flex items-center justify-center transition-opacity duration-300 group-hover:bg-background/45">
  ...
  return (
    <section id="video-resources" className="relative py-24 px-4 overflow-hidden">
      <div className="relative z-20 max-w-7xl mx-auto">
        ...
        <div className="scroll-fade-up mt-8 max-w-3xl mx-auto visible">
          <div className="glass-premium p-6 rounded-lg border border-primary/30 backdrop-blur-md">
